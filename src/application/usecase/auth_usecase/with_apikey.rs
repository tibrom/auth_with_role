...
use super::actions::authenticators::with_apikey::CreateJwtWithApiKeyAction;
use super::actions::user_attribute::api_key::CreateApiKeyByEmailPasswdAction;
    ...
    U: UserProviderFactory
{
    ...
    pub async fn create_api_key(
        ...
        let create_api_key_sub_case = CreateApiKeyByEmailPasswdAction::new(
    ...
    U: UserProviderFactory
{
    ...
    pub async fn login(
        ...
        let create_jwt_use_case = CreateJwtWithApiKeyAction::new(
            &self.user_provider_factory,
            &self.verifies_provider_factory,
            &self.jwtprovider_factory
        );

        let token_pair_dto = match create_jwt_use_case.execute(dto.api_key).await {
            Ok(v) => v,
            Err(e) => return self.handler_error(e)
        };
